...
//      case META_SCALEVIEWPORTEXT:
      case META_LINETO:
      {
        long x1 = rec->param1;
        long y1 = rec->param2;
        dc->DrawLine(WXROUND(lastX), WXROUND(lastY), x1, y1);
        break;
      }
      case META_MOVETO:
      {
...
//      case META_PIE: // DO!!!
      case META_RECTANGLE:
      {
        dc->DrawRectangle(rec->param1, rec->param2,
                          rec->param3 - rec->param1,
                          rec->param4 - rec->param2);
        break;
      }
      case META_ROUNDRECT:
      {
        dc->DrawRoundedRectangle(rec->param1, rec->param2,
                          rec->param3 - rec->param1,
                          rec->param4 - rec->param2,
                          rec->param5);
        break;
