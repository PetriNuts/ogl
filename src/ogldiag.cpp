...
//        dc.DrawEllipse(WXROUND(crossing->m_intersect.x - (arcWidth/2.0) + 0.5), WXROUND(crossing->m_intersect.y - (arcWidth/2.0) + 0.5),
//           arcWidth, arcWidth);
...
*/
        ...
        dc.DrawArc( WXROUND(arcX1), WXROUND(arcY1), WXROUND(arcX2), WXROUND(arcY2),
            WXROUND(crossing->m_intersect.x), WXROUND(crossing->m_intersect.y));

        dc.SetPen(*wxWHITE_PEN);
        dc.DrawLine( WXROUND(arcX1), WXROUND(arcY1), WXROUND(arcX2), WXROUND(arcY2) );
